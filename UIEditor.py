...
class TextEditor(object):
    ...
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.copybutton, 0, 14, 2, 1)
        # 粘贴
        ...
        self.gridLayout.addWidget(self.pastebutton, 0, 15, 2, 1)
        # 剪切
        ...
        self.gridLayout.addWidget(self.cutbutton, 0, 16, 2, 1)
        #分割线
        ...
        self.gridLayout.addWidget(self.bleft, 0, 0, 2, 1)
        # 居中对齐
        ...
        self.gridLayout.addWidget(self.bmiddle, 0, 1, 2, 1)
        # 右对齐
        ...
        self.gridLayout.addWidget(self.bright, 0, 2, 2, 1)
        # 搜索文本
    ...
    def retranslateUi(self, Form):
        ...
        self.bbackward.setToolTip('后退')
        self.bforward.setIcon(QtGui.QIcon('img/forward.png'))
        self.bforward.setToolTip('前进')
